        ...
        <table class="table table-bordered table-hover">
            ...
            <c:forEach items="${requestScope.commodities}" var="com">
                <tr>
                    ...
                    <td style="text-align:center" ><a href="CommodityServlet?action=searCom_id&id=${com.id}&com_edit=true">修改</a></td>
                    <td style="text-align:center" ><a class="deleteclass" href="CommodityServlet?action=delCom&id=${com.id}">删除</a></td>
                </tr>
            </c:forEach>
